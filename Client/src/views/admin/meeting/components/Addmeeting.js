...
const AddMeeting = (props) => {
    const { onClose, isOpen, setAction, from, fetchData, view, meetingId } = props;
    ...
    const AddData = async () => {
        try {
            setIsLoding(true);
            let response = await postApi('api/meeting/add', {
                ...values,
            });
    ...
    return (
        <Modal onClose={onClose} isOpen={isOpen} isCentered>
            ...
            <ModalContent height={'580px'}>
                ...
                <ModalBody overflowY={'auto'} height={'400px'}>
                    ...
                    <Grid templateColumns="repeat(12, 1fr)" gap={3}>
                        <GridItem colSpan={{ base: 12 }}>
                            ...
                            <Input fontSize="sm" onChange={handleChange} onBlur={handleBlur} value={values.agenda} name="agenda" placeholder="Agenda" fontWeight="500" borderColor={errors.agenda && touched.agenda ? 'red.300' : null} />
                        ...
                        <GridItem colSpan={{ base: 12 }}>
                            ...
                            <Input fontSize="sm" onChange={handleChange} onBlur={handleBlur} value={values.location} name="location" placeholder="Location" fontWeight="500" borderColor={errors.location && touched.location ? 'red.300' : null} />
                            <Text mb="10px" color={'red'} fontSize="sm">
                                {' '}
                        ...
                        <GridItem colSpan={{ base: 12 }}>
                            ...
                            <Input fontSize="sm" type="datetime-local" onChange={handleChange} onBlur={handleBlur} min={dayjs(todayTime).format('YYYY-MM-DD HH:mm')} value={values.dateTime} name="dateTime" placeholder="Date Time" fontWeight="500" borderColor={errors.dateTime && touched.dateTime ? 'red.300' : null} />
                            <Text fontSize="sm" mb="10px" color={'red'}>
                                {' '}
                        ...
                        <GridItem colSpan={{ base: 12 }}>
                            ...
                            <Textarea resize={'none'} fontSize="sm" placeholder="Notes" onChange={handleChange} onBlur={handleBlur} value={values.notes} name="notes" fontWeight="500" borderColor={errors.notes && touched.notes ? 'red.300' : null} />
                ...
                <ModalFooter>
                    <Button size="sm" variant="brand" me={2} disabled={isLoding ? true : false} onClick={handleSubmit}>
